...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full mb-8 border-border hover:border-primary/50 transition-colors cursor-default">
        ...
        >
          I'm <span className="text-foreground font-semibold">Afjal</span>, a
          Full Stack Developer dedicated to building high-performance,
          beautiful, and user-centric web applications that leave a lasting
          impression.
        </p>
